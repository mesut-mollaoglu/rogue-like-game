...
bool Graphics::InitGraphics(HWND hwnd) {
	...
	Graphics::CreatePixelShader(L"ShaderFiles/MainPixelShader.hlsl", this->mainPixelShader);
	Graphics::CreatePixelShader(L"ShaderFiles/PixelShader.hlsl", this->pixelShader);
	Graphics::CreateVertexShader(L"ShaderFiles/VertexShader.hlsl", this->vertexShader, this->inputLayout, ied, ARRAYSIZE(ied));
